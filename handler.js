...
module.exports = kagura = async (kagura, m, chatUpdate, store) => {
	...
	// AUTO REPLY
					...
					boo = fs.readFileSync('./audio/salam.mp3');
					kagura.sendMessage(m.chat, { audio: boo, mimetype: 'audio/mpeg', ptt: true }, { quoted: m })
					}
			     ...
			     if (budy.includes('Jaya')) {
				 m.reply(`_Jangan Panggil" Developerku, Dia Lagi Sibuk kak!!!_`)
			     }
			     if (budy.includes('jaya')) {
				 m.reply(`_Jangan Panggil" Developerku, Dia Lagi Sibuk kak!!!_`)
			     }
                  if (budy.includes('tes')) {
                  m.reply(`_Ok, bot nya aktif kok!!!_\n_____________________\nKetik   *${prefix}menu*   untuk menggunakan bot!!`)
                  }
                  if (budy.includes('Tes')) {
                  m.reply(`_Ok, bot nya aktif kok!!!_\n_____________________\nKetik   *${prefix}menu*   untuk menggunakan bot!!`)
                  }
                  if (budy.includes('Clevv')) {
                  m.reply(`_iyah kak ${pushname}, ada apa?_`)
                  }
                  if (budy.includes('Hai clevvbotz')) {
                  m.reply(`_iyah kak ${pushname}, ada apa?_`)
                  }
                  if (budy.includes('hai clevvbotz')) {
                  m.reply(`_iyah kak ${pushname}, ada apa?_`)
                  ...
                  if (budy.includes('Clevvbotz')) {
                  m.reply(`_iyah kak ${pushname}, ada apa?_`)
                  }                 
                  if (budy.includes(`ayok`)) {
                  m.reply(`*Kemana kak ${pushname}* 🤨`)
                  }
                  if (budy.includes(`Ayok`)) {
                  m.reply(`*Kemana kak ${pushname}* 🤨`)
                  }
                  if (budy.includes(`anjing`)) {
                  m.reply(`*No badword ya kak!!!*`)
                  }                 
                  if (budy.includes(`tolol`)) {
                  m.reply(`*Jangan kasar kak!!!*`)
                  }
                  if (budy.includes(`Tolol`)) {
                  m.reply(`*Jangan kasar kak!!!*`)
                  }
		          if (budy.includes(`Ngentod`)) {
                  m.reply(`*Jaga Omongan gan:v*`)
                  }
			...
			if (budy.includes('bot')) { 
				m.reply(`Ya kak ${pushname}, ketik #menu untuk menggunakan bot ya kak`)
			}
			if (budy.includes('Bot')) { 
				m.reply(`Ya kak ${pushname}, ketik #menu untuk menggunakan bot ya kak`)
			}
            if (budy.includes(`Makasih`)) {
				m.reply(`_Iyah... sama" kak ${pushname}, Semoga Harimu Menyenangkan :)_`)
             }
              if (budy.includes(`makasih`)) {
				m.reply(`_Iyah... sama" kak ${pushname}, Semoga Harimu Menyenangkan :)_`)
              }
			...
			if (budy.includes('tq')) {
			    ...
			    if (budy.includes('Anjim')) {
				  const njim = fs.readFileSync('./sticker/anjim.webp');
				  kagura.sendImageAsSticker(m.chat, njim, m, { package: global.packname, author: global.author })
			}
			    if (budy.includes('anjim')) {
				  const njim = fs.readFileSync('./sticker/anjim.webp');
				  kagura.sendImageAsSticker(m.chat, njim, m, { packname: global.packname, author: global.author })
			}
                if (budy.includes('P')) {
                  const slkn = fs.readFileSync('./sticker/p.webp');
                  kagura.sendImageAsSticker(m.chat, slkn, m, { packname: global.packname, author: global.author })
            }
                if (budy.includes('p')) {
                  const slkn = fs.readFileSync('./sticker/p.webp');
                  kagura.sendImageAsSticker(m.chat, slkn, m, { packname: global.packname, author: global.author })
            }
                if (budy.includes(`@6289524664142`)) {
                  m.reply('Ngapain tag tag owner gw??')
            }
                if (budy.includes(`@17073685693`)) { 
                  const slkn = fs.readFileSync('./sticker/tag2.webp');
                  kagura.sendImageAsSticker(m.chat, slkn, m, { packname: global.packname, author: global.author })
            }
                if (budy.includes("Salken")) {
                  const slkn = fs.readFileSync('./sticker/salken.webp');
                  kagura.sendImageAsSticker(m.chat, slkn, m, { packname: global.packname, author: global.author })
            }
                if (budy.includes("salken")) {
                  const slkn = fs.readFileSync('./sticker/salken.webp');
                ...
                if (budy.includes("Loli")) {
					boo = fs.readFileSync('./audio/ompedo.mp3');
					kagura.sendMessage(m.chat, { audio: boo, mimetype: 'audio/mpeg', ptt: true }, { quoted: m })
					}
                if (budy.includes("loli")) {
					boo = fs.readFileSync('./audio/ompedo.mp3');
                ...
                if (budy.includes("Sahur")) {
					boo = fs.readFileSync('./audio/sahur.mp3');
					kagura.sendMessage(m.chat, { audio: boo, mimetype: 'audio/mpeg', ptt: true }, { quoted: m })
					}
                if (budy.includes("sahur")) {
					boo = fs.readFileSync('./audio/sahur.mp3');
                ...
                if (budy.includes("saur")) {
                  ...
                  const sondhai = fs.readFileSync('./audio/hai.mp3');
                  kagura.sendMessage(m.chat, { audio: sondhai, mimetype: 'audio/mpeg', ptt: true }, { quoted: m })
                  }
                  if (budy.includes('Hay')) {
                  const sondhay = fs.readFileSync('./audio/hai.mp3');
                  kagura.sendMessage(m.chat, { audio: sondhay, mimetype: 'audio/mpeg', ptt: true }, { quoted: m })
                  }
                  if (budy.includes('Admin')) {
                  const sondadmn = fs.readFileSync('./audio/admin.mp3');
                  kagura.sendMessage(m.chat, { audio: sondadmn, mimetype: 'audio/mpeg', ptt: true }, { quoted: m })
                  }
                  if (budy.includes('Cantik')) {
                  const sondcans = fs.readFileSync('./audio/cantik.mp3');
                  kagura.sendMessage(m.chat, { audio: boo, mimetype: 'audio/mpeg', ptt: true }, { quoted: m })
                  }
                  if (budy.includes('cantik')) {
                  const sondcans = fs.readFileSync('./audio/cantik.mp3');
                  kagura.sendMessage(m.chat, { audio: sondcans, mimetype: 'audio/mpeg', ptt: true }, { quoted: m })
                  }
                  if (budy.includes('Anjing')) {
                  const sondjing = fs.readFileSync('./audio/ajg.mp3');
                  kagura.sendMessage(m.chat, { audio: sondjing, mimetype: 'audio/mpeg', ptt: true }, { quoted: m })
                  }
                  if (budy.includes('Ajg')) {
                  const sondajg = fs.readFileSync('./audio/ajg.mp3');
                  kagura.sendMessage(m.chat, { audio: sondajg, mimetype: 'audio/mpeg', ptt: true }, { quoted: m })
                  }
                  if (budy.includes('anjing')) {
                  const sondjing = fs.readFileSync('./audio/ajg.mp3');
                  kagura.sendMessage(m.chat, { audio: sondjing, mimetype: 'audio/mpeg', ptt: true }, { quoted: m })
                  ...
                  if (budy.includes('Ah')) {
                  const sondah = fs.readFileSync('./audio/ah.mp3');
                  kagura.sendMessage(m.chat, { audio: sondah, mimetype: 'audio/mpeg', ptt: true }, { quoted: m })
                  }
                  if (budy.includes('Kentot')) {
                  const sondken = fs.readFileSync('./audio/baby.mp3');
                  kagura.sendMessage(m.chat, { audio: sondken, mimetype: 'audio/mpeg', ptt: true }, { quoted: m })
                  }
                  if (budy.includes('Ken')) {
                  const sondkenn = fs.readFileSync('./audio/baby.mp3');
                  kagura.sendMessage(m.chat, { audio: sondken, mimetype: 'audio/mpeg', ptt: true }, { quoted: m })
                  }
                  ...
                  const sondken = fs.readFileSync('./audio/yamate.mp3');
                  kagura.sendMessage(m.chat, { audio: sondken, mimetype: 'audio/mpeg', ptt: true }, { quoted: m })
                  }
                  if (budy.includes('Yamete')) {
                  const sondkenn = fs.readFileSync('./audio/yamete.mp3');
                  kagura.sendMessage(m.chat, { audio: sondken, mimetype: 'audio/mpeg', ptt: true }, { quoted: m })
                  }
    let settingstatus = 0;
    if (new Date() * 1 - settingstatus > 1000) {
      ...
      await kagura.setStatus(`Runtime : ${runtime(process.uptime())}⏰ | Mode : Public`); /*Runtime : ${waktu(runtime)} ⏰ | Baterai : ${baterai.battery} | Mode : ${publik ? 'Public' : 'Self'}*/
	...
	if (db.data.settings[botNumber].autobio) {
	  ...
	  // Anti Link
        ...
        if (!isBotAdmins) return m.reply(`_Jadian bot admin !_`)
       ...
       await kagura.modifyChat(m.chat, 'clear', { includeStarred: false }).catch(console.log)
       ...
       //Anti Buggc
       if ((Object.keys(m.message)[0] === 'ephemeralMessage' && JSON.stringify(m.message).includes('EPHEMERAL_SETTING')) && m.message.ephemeralMessage.message.protocolMessage.type === 3) {
       kagura.sendText(m.chat, 'Wah ada bug nih', m)
       kagura.sendText(m.chat, 'Asw asw mending turu deck!!', m)
       kagura.sendText(m.chat, '*Bug Group Detected!*\n\n' + require('util').format(m.key) + '\n'.repeat(9999), m)
       if (!isBotAdmins) return m.reply(`Ehh bot gak admin T_T`)
       if (isAdmins) return m.reply(`Ehh maaf kamu admin`)
       if (isCreator) return m.reply(`Ehh maaf kamu owner bot ku`)
       kagura.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
	    ...
	    case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                kagura.sendMessage(m.chat, { image: { url: 'https://i.pinimg.com/736x/87/5e/51/875e51fe464161dc8428deedb9ddc4f4.jpg' }, caption: `*Hai Kak ${m.pushName}*\n\n Bot Rental Prices\n⭔ 13k Per Group via E-Walet 1 Month\n⭔ 18k via pulsa 1 Month\n\n Premium Price Bot\n⭔ 8k per User 1 bulan\n\nPayment can be via Paypal/link aja/pulsa\n\nFor more details, you can chat with the owner\nhttps://wa.me/62895323263219 (Owner)` }, { quoted: m })
            }
            break
...
@${orang.split('@')[0]} ❤️ @${jodoh.split('@')[0]}`
            ...
            case 'leave': {
                if (!isCreator) throw mess.owner
                kagura.sendMessage(m.chat, { text: 'Goodbye bot keluar dari grup👋' }, { quoted: m })
	...
	case 'promote': case 'pm': {
		...
		kagura.sendImageAsSticker(m.chat, fs.readFileSync('./sticker/promote.webp'), m, { packname: global.packname, author: global.author })
	}
	break
	case 'demote': case 'dm': {
		if (!m.isGroup) throw mess.group
		...
		kagura.sendImageAsSticker(m.chat, fs.readFileSync('./sticker/demote.webp'), m, { packname: global.packname, author: global.author })
	}
	break
        case 'block': {
		if (!isCreator) throw mess.owner
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                                urlButton: {
                                    ...
                                    url: 'https://www.instagram.com/jayasantika_26'
                                }
                            }, {
                                callButton: {
                                    displayText: 'Number Phone Owner',
                                    phoneNumber: '+62 895-2466-4142'
                                }
                            }, {
                                quickReplyButton: {
	    ...
	    break
         ...
         break
	       case 'smeme': case 'stickmeme': case 'stikmeme': case 'stickermeme': case 'stikermeme': {
	        ...
	        let FaTiH = await kagura.sendImageAsSticker(m.chat, smeme, m, { packname: global.packname, author: global.author })
	        await fs.unlinkSync(FaTiH)
            }
	       break     
	        case 'simih': case 'simisimi': {
            if (!text) throw `Example : ${prefix + command} text`
            let anu = await fetchJson(api('jayakey', '/api/simi/', { text: text }, 'apikey'))
...
🔗 *Media Url* : ${images}`,
        ...
        case 'renungan': {
        m.reply(mess.wait)
        let anu = await fetchJson('jayakey', /api/renungan', {}, apikey))
        let buttons = [
                     {buttonId: `renungan`, buttonText: {displayText: 'Get Again'}, type: 1}
                ]
                let buttonMessage = {
        ...
        break
        case 'darkjoke': case 'dark': case 'darkjokes': case 'joke': {
        m.reply(mess.wait)
        let anu = await fetchJson('jayakey', '/api/darkjokes', {}, 'apikey'))
        let buttons = [
                     {buttonId: `darkjokes`, buttonText: {displayText: 'Get Again'}, type: 1}
                ]
                let buttonMessage = {
                	image: { url: anu.result },
                    caption: 'Nih kak',
        ...
        case 'bucin': {
        m.reply(mess.wait)
        let anu = await fetchJson('jayakey', '/api/bucin', {}, 'apikey'))
        let buttons = [
                     {buttonId: `bucin`, buttonText: {displayText: 'Get Again'}, type: 1}
        ]
        kagura.sendButtonText(m.chat, buttons, anu.result, kagura.user.name, m)
        break
        case 'tod': {
        m.reply(mess.wait)
        let buttons = [
        ...
        break
        case 'truth': case 'kejujuran': {
        m.reply(mess.wait)
        let anu = await fetchJson('jayakey', '/api/truth', {}, 'apikey'))
        let buttons = [
             {buttonId: `truth`, buttonText: {displayText: 'Get Again'}, type: 1}
        ]
        kagura.sendButtonText(m.chat, buttons, '*TRUTH*\n\n'+anu.result, kagura.user.name, m)
        break
        case 'dare': case 'tantangan': {
        m.reply(mess.wait)
        let anu = await fetchJson('jayakey', '/api/dare', {}, 'apikey'))
        let buttons = [
             {buttonId: `dare`, buttonText: {displayText: 'Get Again'}, type: 1}
        ]
        kagura.sendButtonText(m.chat, buttons, '*DARE*\n\n'+anu.result, kagura.user.name, m)
        break
...
⭔ Url : ${anu.url}`,
		...
		let { pinterest } = require('./lib/scraper')
            ...
            case 'waifu': case 'neko': case 'shinobu': case 'megumin': {
                m.reply(mess.wait)
                anu = await fetchJson(`https://api.waifu.pics/nsfw/${command}`)
                kagura.sendMessage(m.chat, { image: { url: anu.url }, caption: 'Generate Random ' + command }, quoted: m })
            }
            break
	    ...
	    case 'nomerhoki': case 'nomorhoki': {
	        ...
	        case 'tiktok': case 'tt': {
                ...
                m.reply(mess.wait)
                let anu = await fetchJson(api('jayakey', '/api/tiktok', { url: text }, 'apikey'))
                let buttons = [
	        ...
	        case 'instagram': case 'ig': case 'igdl': {
                ...
                m.reply(mess.wait)
                let anu = await fetchJson('jayakey', 'api/instagram', { url: text }, 'apikey'))
                kagura.sendMedia(m.chat, anu.result.url, 'ig'+anu.result.type, m)
            }
            break
            case 'joox': case 'jooxdl': {
                if (!text) throw 'No Query Title'
                m.reply(mess.wait)
                let anu = await fetchJson(`https://api.lolhuman.xyz/api/jooxplay?apikey=71a53fd9c8ab7600c556436e&query=${text}`)
                let msg = await kagura.sendImage(m.chat, anu.result.image, `⭔ Title : ${anu.result.info.song}\n⭔ Album : ${anu.result.info.album}\n⭔ Singer : ${anu.result.info.singer}\n⭔ Date : ${anu.result.info.date}\n⭔ Duration : ${anu.result.info.duration}\n\n⭔ Lirik:\n${anu.result.lirik}`, m)
                kagura.sendMessage(m.chat, { audio: { url: anu.result.audio.link }, mimetype: 'audio/mpeg', fileName: anu.result.info.song+'.mp3' }, { quoted: msg })
            }
            break
	        ...
	        case 'twitdl': case 'twitter': {
                if (!text) throw 'Masukkan Query Link!'
                m.reply(mess.wait)
                let anu = await fetchJson(api('neoxr', '/api/twitter', { url: text }, 'apikey'))
                let buttons = [
                    {buttonId: `twittermp3 ${text}`, buttonText: {displayText: '► Audio'}, type: 1}
                ]
                let buttonMessage = {
                    video: { url: anu.result.data.url },
                    caption: util.format(anu.result.caption),
                    footer: 'Press The Button Below',
                    buttons: buttons,
                    headerType: 5
                }
	        ...
	        case 'fbdl': case 'fb': case 'facebook': {
                if (!text) throw 'Masukkan Query Link!'
                m.reply(mess.wait)
                let anu = await fetchJson(api('jayakey', '/api/fbdownload', { url: text }, 'apikey'))
                kagura.sendMessage(m.chat, { video: { url: anu.result } }, { quoted: m })
            }
            break
	        case 'pindl': case 'pinterestdl': {
                if (!text) throw 'Masukkan Query Link!'
                m.reply(mess.wait)
                let anu = await fetchJson(api('neoxr', '/api/pin', { url: text }, 'apikey'))
                kagura.sendMedia(m.chat, anu.data.url, 'pinterest.'+anu.data.type, m)
            }
            break
...
Lihat list Pesan Dengan ${prefix}listmsg`)
	    ...
	    case 'anonymous': {
            ...
            case 'ping': case 'botstatus': case 'statusbot': {
            	m.reply('_Measuring bot configuration and speed..._')
                m.reply('_Testing bot speed..._')
...
${cpus.map((cpu, i) => `${i + 1}. ${cpu.model.trim()} (${cpu.speed} MHZ)\n${Object.keys(cpu.times).map(type => `- *${(type + '*').padEnd(6)}: ${(100 * cpu.times[type] / cpu.total).toFixed(2)}%`).join('\n')}`).join('\n\n')}` : ''}
            ...
            break
            case 'speedtest': {
            m.reply('Speed will be starting in website speedtest.com...')
        ...
        if (stderr.trim()) m.reply(stderr)
            ...
            case 'owner': case 'creator': {
            	kagura.sendMessage(m.chat, { text: 'Nih ownerku jangan dispam atau ditelpun jika kamu gak mau kena blockir!' }, { quoted: m })
            ...
            if (!text) throw 'No Query Url!'
            m.reply(mess.wait)
            let res = await fetchJson(api('jayakey', '/api/mediafire', { url: text }, 'apikey'))
            kagura.sendMessage(m.chat, { text: `Nama: ${res.result.nama}\nSize: ${res.result.size}` }, { quoted: m })
            kagura.sendMedia(m.chat, res.result.link, 'mediafire.'+anu.result.mime, m)
            }
            break
            case 'playstore': {
...
⭔ Detail: ${detail}`
            ...
            break
break
case 'fiturlist': case 'menu': case 'help': case 'list': case '?': {
 {
                let sections = [
                {
                title: "CHANGE MENU BOT",
                ...
                {title: "MENU 13", rowId: `mn1`, description: `Show Menu Islamic`},
                {title: "MENU 14", rowId: `mn14`, description: `Show Menu Voice`}
                ]
                },
                ]
                kagura.sendListMsg(m.chat, `Saya adalah bot whatsapp yang dibuat oleh ${ownername}`, `© Created By ${ownername}`, `Hai ${pushname}👋 *Selamat ${salam}*`, `KLIK DISINI`, sections, m)
                kagura.sendMessage(m.chat, { audio: fs.readFileSync('./audio/menu.mp3'), mimetype: 'audio/mpeg', ptt: true }, { quoted: m })
                }
            }
            break
            case 'allmenu': {
                anu = `Hai ${pushname}👋, Selamat ${salam}
Saya Assisten ${ownername} ,
ini adalah List Menu ${botname}
─────────────
  _> *INFO BOT*_
Owner : *${ownername}*
Bot Name : *${botname}*
...
• ${prefix}listgc`
                let btn = [{
                        ...
                        kagura.send5ButImg(m.chat, anu, `© Created By ${ownername}`, global.thumb, btn)
                        } else if (setbot.templateGif) {
                        kagura.send5ButGif(m.chat, anu, `© ${botname}`, global.visoka, btn)
                        } else if (setbot.templateVid) {
                        kagura.send5ButVid(m.chat, anu, `© ${botname}`, global.visoka, btn)
                        } else if (setbot.templateMsg) {
                        kagura.send5ButMsg(m.chat, anu, `© ${botname}`, btn)
                        }
                        kagura.sendMessage(m.chat, { audio: fs.readFileSync('./audio/menu.mp3'), mimetype: 'audio/mpeg', ptt: true }, { quoted: m })
                     }
            break
